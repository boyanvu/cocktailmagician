...
namespace CocktailsMagician.Data.Migrations
{
    ...
    [Migration("20200512101650_seed_data")]
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.BarReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 819, DateTimeKind.Utc).AddTicks(731),
                        ...
                        new
                        {
                            ...
                            Comment = "Not bad",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 819, DateTimeKind.Utc).AddTicks(1716),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 2,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 819, DateTimeKind.Utc).AddTicks(1756),
                        ...
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 819, DateTimeKind.Utc).AddTicks(1772),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.CocktailReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Too sour",
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 820, DateTimeKind.Utc).AddTicks(283),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 820, DateTimeKind.Utc).AddTicks(1178),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 820, DateTimeKind.Utc).AddTicks(1209),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        },
                        new
                        {
                            ...
                            Comment = "Not bad.",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 12, 10, 16, 48, 820, DateTimeKind.Utc).AddTicks(1221),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c592b2cd-c2f8-49a8-8394-bc26e711bee3",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEH0GWb9YLu8ayVcyi/BMDL2ESrZoY8drS4k35h/oBCO771ps3w2joNkDrcypJb5f/Q==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "527e39e6-4eb5-474c-bc25-52509a2a9238",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPC72jXlz1MI0WjiuPQPQKMDibChiZdKyud9Tim1XYMeysuxkO9XhMy7TZGIFbr5Ig==",
                            PhoneNumberConfirmed = false,
