...
namespace CocktailsMagician.Data.Migrations
{
    ...
    [Migration("20200514094426_addedUnlistedOnForCityAndIT")]
    partial class addedUnlistedOnForCityAndIT
    {
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.BarReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 517, DateTimeKind.Utc).AddTicks(9068),
                        ...
                        new
                        {
                            ...
                            Comment = "Not bad",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 518, DateTimeKind.Utc).AddTicks(56),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 2,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 518, DateTimeKind.Utc).AddTicks(82),
                        ...
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 518, DateTimeKind.Utc).AddTicks(91),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.CocktailReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Too sour",
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 518, DateTimeKind.Utc).AddTicks(9266),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 519, DateTimeKind.Utc).AddTicks(309),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 519, DateTimeKind.Utc).AddTicks(332),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        },
                        new
                        {
                            ...
                            Comment = "Not bad.",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 14, 9, 44, 25, 519, DateTimeKind.Utc).AddTicks(341),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8aaedced-44e0-4510-9c61-d8457f286592",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEONXQaY70EKLXl/2Orw5EjLPpe0woeZJ4vqTxH97jHClC23oERnVfT0Rzb5zTN5X4w==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ca6affe2-b3b7-4075-88d6-03c9dff152e1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAvwgDHhi8p44AtkFo/iATY/A5q2Zr0VmpNufEM/9AwSUVzrhNduQZ22hsTBXXiI8w==",
                            PhoneNumberConfirmed = false,
