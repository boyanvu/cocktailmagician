...
namespace CocktailsMagician.Data.Migrations
{
    ...
    [Migration("20200515093445_addedCreatedOnUser")]
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.BarReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 509, DateTimeKind.Utc).AddTicks(5533),
                        ...
                        new
                        {
                            ...
                            Comment = "Not bad",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 509, DateTimeKind.Utc).AddTicks(6658),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 2,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 509, DateTimeKind.Utc).AddTicks(6693),
                        ...
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 509, DateTimeKind.Utc).AddTicks(6703),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.CocktailReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Too sour",
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 510, DateTimeKind.Utc).AddTicks(7986),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 510, DateTimeKind.Utc).AddTicks(8906),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 510, DateTimeKind.Utc).AddTicks(8931),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        },
                        new
                        {
                            ...
                            Comment = "Not bad.",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 15, 9, 34, 44, 510, DateTimeKind.Utc).AddTicks(8938),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cc17bced-7e46-4564-80e1-128b3ad0bfe6",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELlhAvfTwRDNKiDS+V/w6TxEFb6/LOVZ5kM9byR29yRYccm9XC8ITMljVHwcMQl8QA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ee019a54-1fcc-4971-81bd-9a575867d5ab",
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEN/vnIqGE46yaCrKRh2n9eDslO1i9GTPUbghzUeyJBNerSwEN2sYdm9eMgvGqcGmRw==",
                            PhoneNumberConfirmed = false,
