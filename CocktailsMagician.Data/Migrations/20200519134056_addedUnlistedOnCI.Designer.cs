...
namespace CocktailsMagician.Data.Migrations
{
    ...
    [Migration("20200519134056_addedUnlistedOnCI")]
    partial class addedUnlistedOnCI
    {
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.BarReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 907, DateTimeKind.Utc).AddTicks(7170),
                        ...
                        new
                        {
                            ...
                            Comment = "Not bad",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 907, DateTimeKind.Utc).AddTicks(8131),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 2,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 907, DateTimeKind.Utc).AddTicks(8158),
                        ...
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 907, DateTimeKind.Utc).AddTicks(8171),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.CocktailReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Too sour",
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 908, DateTimeKind.Utc).AddTicks(7411),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 908, DateTimeKind.Utc).AddTicks(8277),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 908, DateTimeKind.Utc).AddTicks(8302),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        },
                        new
                        {
                            ...
                            Comment = "Not bad.",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 5, 19, 13, 40, 54, 908, DateTimeKind.Utc).AddTicks(8312),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "27662d55-ebd8-4029-92b4-b65e389d5efb",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBNrfHWkG3cdN0mI8WiEYFZWl9RlUIhH+LikLavN4R2+Ot6n+742NiQyTh1HGAo5Hw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d0d9f8ad-63e6-44df-8d70-311e05bede24",
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBXLwYuhUCzIQ+eeC1bbypG6AtE3Ucu8+rdZ1YcvI2lT0TY30f/Ery35eAb2HuW7rA==",
                            PhoneNumberConfirmed = false,
