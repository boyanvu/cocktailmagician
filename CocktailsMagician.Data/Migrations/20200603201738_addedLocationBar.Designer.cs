...
namespace CocktailsMagician.Data.Migrations
{
    ...
    [Migration("20200603201738_addedLocationBar")]
    partial class addedLocationBar
    {
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.BarReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 579, DateTimeKind.Utc).AddTicks(4532),
                        ...
                        new
                        {
                            ...
                            Comment = "Not bad",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 579, DateTimeKind.Utc).AddTicks(5227),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 2,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 579, DateTimeKind.Utc).AddTicks(5253),
                        ...
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 579, DateTimeKind.Utc).AddTicks(5262),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.CocktailReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Too sour",
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 580, DateTimeKind.Utc).AddTicks(366),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 1,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 580, DateTimeKind.Utc).AddTicks(859),
                            UserId = new Guid("ad513447-0536-432b-a848-ea96ade0040d")
                        },
                        new
                        {
                            ...
                            Rating = 5,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 580, DateTimeKind.Utc).AddTicks(884),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        },
                        new
                        {
                            ...
                            Comment = "Not bad.",
                            Rating = 3,
                            ReviewedOn = new DateTime(2020, 6, 3, 20, 17, 37, 580, DateTimeKind.Utc).AddTicks(893),
                            UserId = new Guid("a137730d-bb81-4611-8fb8-bb777aae86ac")
                        });
                });
            ...
            modelBuilder.Entity("CocktailsMagician.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "01a0e376-6f2d-4cf7-90db-209dd0518d98",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAe/v1th/8hJd/5lk1UrN0FBSnr98nMUxxJ4Pek03tMUiT+3wuc+z09l+gogmOZomA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "80efce02-aae6-43ef-8d38-a4b158de69b1",
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEO/37Jimfz74TlcjdFC+QjMIFVFXOSll7bPzKLf2N2wdOW+aVI/SSd4m+RjR9hLhYw==",
                            PhoneNumberConfirmed = false,
