...
{
    [TestClass]
    public class Cocktail_Has_Ingredient_Should
    {
        [TestMethod]
        public async Task Return_True_If_Cocktail_Has_Ingredient()
        {
            var options = Utils.GetOptions(nameof(Return_True_If_Cocktail_Has_Ingredient));
            ...
            using (var assertContext = new CMContext(options))
            {
                ...
                var result = await sut.DoesCocktailHaveIngredient(cocktail.Id, ingredient.Id);
